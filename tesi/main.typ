...
// ---------- Ringraziamenti ----------
#let acknowledgments = [
Desidero innanzitutto ringraziare il professor Gian Luca Pozzato per la disponibilità e per avermi dato la possibilità di lavorare su questo progetto interessante, nonostante i tempi di lavoro fossero stretti. 

Un ringraziamento speciale ai miei genitori, per il sostegno costante e la pazienza dimostrata in questi anni, soprattutto nei momenti in cui non ero del tutto sicuro del percorso che stavo affrontando.  

Ringrazio anche i miei amici e colleghi universitari  per i confronti, le risate e il supporto quotidiano, dentro e fuori l’università.  
